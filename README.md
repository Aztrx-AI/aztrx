...
`uses: Aztrx-AI/aztrx@v0.5.2` runs **aztrx-cli 0.5.2** — the action reads its own version, so
...
jobs:
  aztrx:
    uses: Aztrx-AI/aztrx/.github/workflows/aztrx-pr.yml@v0.5.2
    secrets:
